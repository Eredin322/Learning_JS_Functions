...
const t12 = arr => arr.reduce((accum, item) => accum < item ? accum = item : accum)

document.querySelector('.b-12').addEventListener('click', function () {
    document.querySelector('.out-12').textContent = t12([119, 22]);
})
...
const t13 = (min, max) => Math.floor(min + Math.random() * (max - min - 0.5));
...
const t14 = str => str.trim() === '' ? false : str.trim();
...
const t15 = val => Number(val) ? true : false
...
document.querySelector('.b-16').addEventListener('click', function () {
    document.querySelector('.out-16').textContent = t16([4, 5]);
})
...
const t18 = (arr, number) => arr.includes(number);

document.querySelector('.b-18').addEventListener('click', function () {
    document.querySelector('.out-18').textContent = t18([4, 5, 6], 7);
})
...
const t19 = (str, arg) => arg === true ? str.split('').reverse().join('') : str
